...
public class DataGeneratorUtil {
    ...
    public static String getRandomString(int length){
        String acceptedChars = "ABCDEFGHIJKLMNOPQRSTWXYZabcdefghfs123456789";
        ...
        for(int i = 0;i<length;i++){
            ...
            System.out.println("In interatia i = " + i + " caracterul alipit este " + acceptedChars.charAt(randomIndex));
        }
